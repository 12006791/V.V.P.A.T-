...
def win2():
    ...
    label1 = tk.Label(win2.window2, text="V.V.P.A.T",width=14, relief=RIDGE, bg="#00EEEE", borderwidth=5)
    ...
    btn2 = tk.Button(frame2, text="Reset", width=10, relief=RAISED, borderwidth=5, bg="red")
    ...
    btn4 = tk.Button(frame3, text="START\nVOTING", width=18, relief=RAISED, borderwidth=5, bg="#FF8C00",command=win3)
...
def win5():
    ...
    label1 = tk.Label(win5.window5, text="V.V.P.A.T",width=14, relief=RIDGE, bg="#CAFF70", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
